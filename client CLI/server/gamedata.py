...
HEROES = {
    UNIT_TYPE["AQUATIC_MAN"]:           {"name": "Aquatic Man",           "stars": 1},
    UNIT_TYPE["BANSHEE"]:               {"name": "Banshee",               "stars": 1},
    UNIT_TYPE["BARDBARIAN"]:            {"name": "Bardbarian",            "stars": 1},
    UNIT_TYPE["BONE_DRAGON"]:           {"name": "Bone Dragon",           "stars": 3},
    UNIT_TYPE["BROZERKER"]:             {"name": "Brozerker",             "stars": 3},
    UNIT_TYPE["BURNT_ONE"]:             {"name": "Burnt One",             "stars": 3},
    UNIT_TYPE["CATAPULT_KNIGHT"]:       {"name": "Catapult Knight",       "stars": 1},
    ...
    UNIT_TYPE["CURSED_STATUE"]:         {"name": "Cursed Statue",         "stars": 2},
    UNIT_TYPE["CYCLOPS_WIZARD"]:        {"name": "Cyclops Wizard",        "stars": 1},
    UNIT_TYPE["DARK_DRACUL"]:           {"name": "Dark Dracul",           "stars": 1},
    UNIT_TYPE["DARK_HORSE"]:            {"name": "Dark Horse",            "stars": 3},
    UNIT_TYPE["DEEP_DRAGON"]:           {"name": "Deep Dragon",           "stars": 2},
    UNIT_TYPE["DEMON_TOTEM"]:           {"name": "Demon Totem",           "stars": 3},
    UNIT_TYPE["DOPPELGANGER"]:          {"name": "Doppelganger",          "stars": 1},
    UNIT_TYPE["DRAGON_LADY"]:           {"name": "Dragon Lady",           "stars": 1},
    UNIT_TYPE["DRAGZILLA"]:             {"name": "Dragzilla",             "stars": 2},
    UNIT_TYPE["DRUIDINATRIX"]:          {"name": "Druidinatrix",          "stars": 3},
    UNIT_TYPE["DUNGEON_MAN"]:           {"name": "Dungeon Man",           "stars": 2},
    UNIT_TYPE["DUST_DEVIL"]:            {"name": "Dust Devil",            "stars": 2},
    UNIT_TYPE["DWARVEN_ARCHER"]:        {"name": "Dwarven Archer",        "stars": 3},
    UNIT_TYPE["ELECTROYETI"]:           {"name": "Electroyeti",           "stars": 1},
    UNIT_TYPE["FAITH_HEALER"]:          {"name": "Faith Healer",          "stars": 1},
    UNIT_TYPE["FROST_GIANT"]:           {"name": "Frost Giant",           "stars": 1},
    UNIT_TYPE["GENIE"]:                 {"name": "Genie",                 "stars": 3},
    UNIT_TYPE["GROOVY_DRUID"]:          {"name": "Groovy Druid",          "stars": 2},
    UNIT_TYPE["HYDRA"]:                 {"name": "Hydra",                 "stars": 3},
    UNIT_TYPE["KRAKEN_KING"]:           {"name": "Kraken King",           "stars": 3},
    UNIT_TYPE["MAGIC_DRAGON"]:          {"name": "Magic Dragon",          "stars": 2},
    UNIT_TYPE["MEDUSA"]:                {"name": "Medusa",                "stars": 2},
    UNIT_TYPE["MINOTAUR"]:              {"name": "Minotaur",              "stars": 1},
    UNIT_TYPE["MISTRESS_MANICURE"]:     {"name": "Mistress Manicure",     "stars": 1},
    UNIT_TYPE["MOON_DRAKE"]:            {"name": "Moon Drake",            "stars": 2},
    UNIT_TYPE["NINJA_DWARF"]:           {"name": "Ninja Dwarf",           "stars": 1},
    UNIT_TYPE["ORC_MONK"]:              {"name": "Orc Monk",              "stars": 1},
    UNIT_TYPE["PIRATE"]:                {"name": "Pirate",                "stars": 3},
    UNIT_TYPE["PLAGUE_ENTREPRENEUR"]:   {"name": "Plague Entrepreneur",   "stars": 2},
    UNIT_TYPE["PLANT_SOUL"]:            {"name": "Plant Soul",            "stars": 2},
    UNIT_TYPE["POLEMASTER"]:            {"name": "Polemaster",            "stars": 3},
    UNIT_TYPE["RABID_DRAGON"]:          {"name": "Rabid Dragon",          "stars": 3},
    UNIT_TYPE["RAGING_REVENANT"]:       {"name": "Raging Revenant",       "stars": 1},
    UNIT_TYPE["ROLLER_WARRIOR"]:        {"name": "Roller Warrior",        "stars": 3},
    UNIT_TYPE["SATYR"]:                 {"name": "Satyr",                 "stars": 3},
    UNIT_TYPE["SAVAGE_CUTIE"]:          {"name": "Savage Cutie",          "stars": 2},
    UNIT_TYPE["SHADOW_ASSASSIN"]:       {"name": "Shadow Assassin",       "stars": 1},
    UNIT_TYPE["SILENT_SPIRIT"]:         {"name": "Silent Spirit",         "stars": 1},
    UNIT_TYPE["SKELETON_KING"]:         {"name": "Skeleton King",         "stars": 1},
    UNIT_TYPE["SNAP_DRAGON"]:           {"name": "Snap Dragon",           "stars": 2},
    UNIT_TYPE["SNIPER_WOLF"]:           {"name": "Sniper Wolf",           "stars": 1},
    UNIT_TYPE["SPECTRAL_DRAGON"]:       {"name": "Spectral Dragon",      "stars": 2},
    UNIT_TYPE["SPIDER_QUEEN"]:          {"name": "Spider Queen",          "stars": 1},
    UNIT_TYPE["SPIKEY_DRAGON"]:         {"name": "Spikey Dragon",         "stars": 3},
    UNIT_TYPE["STORM_DRAGON"]:          {"name": "Storm Dragon",          "stars": 2},
    UNIT_TYPE["STOWAWAY"]:              {"name": "Stowaway",              "stars": 2},
    UNIT_TYPE["UNICORGI"]:              {"name": "Unicorgi",              "stars": 2},
    UNIT_TYPE["UNSTABLE_UNDERSTUDY"]:   {"name": "Unstable Understudy",   "stars": 1},
    UNIT_TYPE["VILE_BILE"]:             {"name": "Vile Bile",             "stars": 2},
    UNIT_TYPE["VOID_WYVERN"]:           {"name": "Void Wyvern",           "stars": 3},
    UNIT_TYPE["VULTURE_DRAGON"]:        {"name": "Vulture Dragon",        "stars": 3},
    UNIT_TYPE["WEE_WITCH"]:             {"name": "Wee Witch",             "stars": 1},
    UNIT_TYPE["WEREDRAGON"]:            {"name": "Weredragon",            "stars": 2},
    UNIT_TYPE["ZOMBIE_SQUIRE"]:         {"name": "Zombie Squire",         "stars": 1},
}
...
def get_starter_heroes():
    """Return starter heroes for new players - typical DragonSoul starting lineup."""
    return [
        {"hero_type": UNIT_TYPE["BARDBARIAN"],    "level": 1, "stars": 1, "rarity": 1},  # WHITE
        ...
        {"hero_type": UNIT_TYPE["ZOMBIE_SQUIRE"], "level": 1, "stars": 1, "rarity": 1},  # WHITE
    ]
...
for _lvl in range(1, 131):
    if _lvl == 1:
        ...
        TEAM_XP_TABLE[_lvl] = TEAM_XP_TABLE[_lvl - 1] + int(100 * (_lvl ** 1.5))
...
for _lvl in range(1, 131):
    if _lvl == 1:
        ...
        HERO_XP_TABLE[_lvl] = int(50 * (_lvl ** 1.3))
